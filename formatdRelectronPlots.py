# Script to plot electron-jet dR distributions from the BHflatTuplizer and make them pretty. John Hakala 12/1/2015
from ROOT import *
...
ElectronJet1 = isoPlotsDir.Get("ElectronJetoverlapdR1")
ElectronJet2 = isoPlotsDir.Get("ElectronJetoverlapdR2")
ElectronJet3 = isoPlotsDir.Get("ElectronJetoverlapdR3")
ElectronJet4 = isoPlotsDir.Get("ElectronJetoverlapdR4")
...
ElectronJet1.GetXaxis().SetTitle("dR(e^{-},jet)")
...
outfile = TFile("output/ElectrondROutFile.root", "RECREATE")
ElectronJetC.Write()
ElectronJetC.SaveAs("output/ElectrondRPlot.pdf")
